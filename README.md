...
Sensor: LM35 (Analógico) - Seleccionado por su linealidad y robustez frente a digitales low-cost.

Indicadores: LEDs de estado (Normal, Alerta Calor, Alerta Frío).

# Arquitectura y Protocolos

El sistema utiliza una arquitectura MQTT estándar:

Dispositivo: El ESP32 publica telemetría JSON ({"temp": 24.5}) en el tópico v1/devices/me/telemetry.

Broker/Cloud: ThingsBoard procesa los datos y ejecuta reglas de alarma.

Usuario: Interfaz web para visualización y control RPC (Remote Procedure Call).
...
Materia: Integración Tecnológica | Fecha: Noviembre 2025
